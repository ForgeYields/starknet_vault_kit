...
pub mod DefiSpringDecoderAndSanitizerComponent {
    ...
    #[embeddable_as(DefiSpringDecoderAndSanitizerImpl)]
    impl DefiSpringDecoderAndSanitizer<
        TContractState, +HasComponent<TContractState>,
    > of IDefiSpringDecoderAndSanitizer<ComponentState<TContractState>> {
        fn claim(
            self: @ComponentState<TContractState>, amount: u128, proof: Span<felt252>,
        ) -> Span<felt252> {
